...
const projectConfig = {
  projectId: 'house-control-d9800',
  databaseURL: 'https://house-control-d9800-default-rtdb.europe-west1.firebasedatabase.app'
  // databaseURL: 'https://house-control-d9800.firebaseio.com'
};
const test = require('firebase-functions-test')(projectConfig, '../../../house-control-d9800-56138041dcec.json');
